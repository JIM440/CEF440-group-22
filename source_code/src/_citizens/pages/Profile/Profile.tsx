    ...
    <IonPage>
      ...
      <IonContent className="ion-padding">
        ...
        <div
          className={
            displayPreferred
              ? "preferred-location-popup"
              : "display-none preferred-location-popup"
          }
        >
          <div>
            ...
            <div className="preferred-locations-list">
              {user.locations?.map((location) => (
                ...
                <div className="location-list-item">
                  <span>latitude:{location.latitude}, Cameroon</span>
                ...
                <div className="location-list-item">
                  <span>longitude:{location.longitude}, Cameroon</span>
                  <div className="remove-preferred-loaction">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="18"
