...
const ResponderAlerts: React.FC = () => {
  ...
  const [reportDisasters, setReportDisasters] = useState([]);
  ...
  useEffect(() => {
    ...
    const unsubscribe = onSnapshot(
      ...
      (snapshot) => {
        ...
        const pendingData = disastersData.filter((disaster) => disaster.status === 'pending');
        setPendingDisasters(pendingData);

        const reportedData = disastersData.filter((disaster) => disaster.incidentStatus === 'reported');
        setReportDisasters(reportedData);
          ...
          <div className="pending-container alerts-container">
            {reportedDisasters.map(disaster => (
              ...
              <div className="status-time">
                  <span className="status pending">{ disaster.status}</span>{' '}
              ...
              <div className="alerts-btn-container">
                ...
                <button
                  onClick={() => {
                    router.push(`/responder/alerts/validate/${disaster.id}`);
                  }}
                  className="btn-link"
                >
                  <span>See More</span>
