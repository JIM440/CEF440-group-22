		...
		<IonPage className="Settings-main-container">
				...
				<IonToolbar>
					<IonButtons slot="start">
						<IonButton className="back-button" onClick={history.goBack}>
							<IonIcon src={backIcon}></IonIcon>
							<IonLabel><FormattedMessage id="back"/></IonLabel>
						</IonButton>
					</IonButtons>
					<IonTitle className="header-title"><FormattedMessage id="Settings"/></IonTitle>
				</IonToolbar>
			</IonHeader>
			...
			<IonContent fullscreen>
				<IonHeader collapse="condense">
					<IonToolbar>
						<IonTitle size="large"><FormattedMessage id="Settings"/></IonTitle>
					</IonToolbar>
				</IonHeader>
				<div id="setting-list">
					<IonItemGroup>
						<IonItemDivider mode="ios">
							<IonLabel><FormattedMessage id="general"/></IonLabel>
						</IonItemDivider>
						...
						<IonItem mode="ios" id="open-modal">
							<IonLabel><FormattedMessage id="language"/></IonLabel>
						</IonItem>
					</IonItemGroup>

					<IonItemGroup>
						<IonItemDivider mode="ios">
							<IonLabel><FormattedMessage id="notification"/></IonLabel>
						</IonItemDivider>
				...
				<IonModal
					...
					<div className="modal-content">
						<IonLabel><FormattedMessage id="language"/></IonLabel>
						<IonRadioGroup value={locale} onIonChange={(ev)=>{setLocale(ev.detail.value)}}>
							<IonItem>
							...
							<IonItem>
								...
								<IonRadio value="fr-FR" aria-label="Francias">Français</IonRadio>
							</IonItem>
						</IonRadioGroup>
					</div>
				</IonModal>
