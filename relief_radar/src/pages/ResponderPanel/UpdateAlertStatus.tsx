import {
  ...
  import fireOccur from '../../assets/images/fire-occurred.jpg';
import BackBtn from './HeaderBack';
  
  const UpdateDisasterStatus: React.FC = () => {
    ...
    return (
      <IonPage>
        ...
        <IonContent>
          ...
          <div className="confirm-disaster disaster-status-update">
            <p>Update  Disaster Status:</p>
            <div className='check-box-container'>
            <IonCheckbox checked={true}>Ongoing</IonCheckbox>
            <IonCheckbox>Potential</IonCheckbox>
            <IonCheckbox>Occurred</IonCheckbox>
            </div>
          </div>
  ...
  export default UpdateDisasterStatus;
