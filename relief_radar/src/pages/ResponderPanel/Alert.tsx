        ...
        {segment === 'pending' ? (
          <div className="pending-container alerts-container">
            <div className="alert-box">
              <div className="status-time">
                <span className="status pending">Pending</span> <p className="time">5 mins ago</p>
              </div>
              ...
              <div className="alerts-btn-container">
                ...
                <button
                  onClick={() => {
                    router.push('/responder/alerts/pending');
                  }}
                  className="btn-link"
                >
                  <span>See More</span>
          ...
          <div className="reported-container alerts-container">
            <div className="alert-box">
              ...
              <div className="alerts-btn-container">
                ...
                <button
                  onClick={() => {
                    router.push('/responder/alerts/reported');
                  }}
                  className="btn-link"
                >
                  <span>See More</span>
          ...
          <div className="detected-container alerts-container">
            <div className="alert-box">
              ...
              <p className="description">
                Detected Fire reported in the vicinity of Mile 17. Evacuation
                underway for areas within the red zone on the map. Firefighters
                are on the scene.
              </p>
              <div className="alerts-btn-container">
