...
import { errorWeatherValue, } from '../../modules/weather/weather'
    ...
    <IonPage>
      <IonContent>
        <div className="top-blue-section">
          <div className="place-detail">Buea, Molyko</div>
          <div className="date-details">Today, 10 June 2024</div>
          ...
          <div className="other-climate-details">
            <div className="weather-details">
              ...
              <div className="actual-value">35 km/h</div>
              <div className="weather-type">wind Speed</div>
            </div>
            <div className="weather-details">
              <IonIcon src={humidity} className="icon" />
              <div className="actual-value">60%</div>
              <div className="weather-type">Humidity</div>
            </div>
            <div className="weather-details">
              <IonIcon src={rain} className="icon" />
              <div className="actual-value">0%</div>
              <div className="weather-type">Precipitation</div>
            </div>
          </div>
        </div>
