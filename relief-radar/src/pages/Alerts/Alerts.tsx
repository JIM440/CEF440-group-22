import {
  ...
  import './Alerts.css';
  import { flameOutline, locateOutline } from 'ionicons/icons';
    ...
    return (
      <IonPage>
        <IonHeader class="ion-no-border">
          ...
          {/* <IonToolbar color='clear'>
                      <IonSearchbar mode='ios' color='light'></IonSearchbar>
                  </IonToolbar> */}
          <IonToolbar color="clear">
            <IonSegment mode="ios" color="light" scrollable={true} value="all">
              ...
              {/* Fires, Earthquakes, Landslides, Tornado, 
  Volcanic Eruptions */}
            </IonSegment>
          </IonToolbar>
        </IonHeader>
  ...
  {/* <div style={{
    ...
    <div className="disaster-status">
      <span className="status potential"></span>
      <span>Potential</span>
    </div>
    <div className="disaster-status">
      <span className="status occured"></span>
      <span>Occured</span>
    </div>
  </div> */}
          <div className="alerts-container">
            ...
            <div className="alert-box">
              ...
              Fire reported in the vicinity of Mile 17.  Evacuation underway for areas within the red zone on the map.
              Firefighters are on the scene.
              </p>
              <div className="map-view">
                <span>View In Map</span>
                <div className="icon-container">
                  <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24"><path fill="none" stroke="#fff" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 18.5L9 17l-6 3V7l6-3l6 3l6-3v7.5M9 4v13m6-10v5.5m6.121 7.621a3 3 0 1 0-4.242 0Q17.506 20.749 19 22q1.577-1.335 2.121-1.879M19 18v.01"/></svg>
                </div>
              </div>
            </div>
            ...
            <div className="alert-box">
              ...
              <div className="disaster-img-type">
                <div className="icon">
                <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24"><path fill="#1e7fdb" d="M9.025 22q-.35 0-.612-.187T8.05 21.3L5.5 13H2v-2h4.25q.325 0 .588.188t.362.512l1.65 5.375L12.025 2.8q.075-.35.35-.575T13 2t.625.213t.35.562l2.175 9.4l1.4-4.475q.1-.325.362-.512T18.5 7t.575.175t.375.475L20.7 11H22v2h-2q-.325 0-.575-.175t-.375-.475l-.475-1.275L16.95 16.3q-.1.325-.375.525T15.95 17t-.6-.238t-.325-.537L13 7.525l-3.025 13.7q-.075.35-.337.55T9.025 22"/></svg>
                </div>
                <div>
                  <h3>Earthquake</h3>
                  <p>Buea, Cameroon</p>
              ...
              <p className="description">
              An earthquake of 7.0 magnitude struck Buea. There are no reports yet of widespread damage or casualties.  However, emergency services are assessing the situation.
              </p>
              <div className="map-view">
                <span>View In Map</span>
                <div className="icon-container">
                  <svg xmlns="http://www.w3.org/2000/svg" width="28" height="22" viewBox="0 0 24 24"><path fill="none" stroke="#fff" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 18.5L9 17l-6 3V7l6-3l6 3l6-3v7.5M9 4v13m6-10v5.5m6.121 7.621a3 3 0 1 0-4.242 0Q17.506 20.749 19 22q1.577-1.335 2.121-1.879M19 18v.01"/></svg>
                </div>
              </div>
            </div>
          </div>
